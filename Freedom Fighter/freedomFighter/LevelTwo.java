...
public class LevelTwo implements Level {
	...
	public LevelTwo() {
		...
		bgMusicSongs[0] = "Sound\\latin america.wav";
		...
		try {
			background = GameDriver.addImage("background\\Mexico City.jpg");
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void draw(Graphics2D g2, boolean[] keys) {
		...
		drawInfoPanel(g2);
		if( (isDefeated() && player.isDoneDying()) || ( (timer3 >= minute / 2) && aliens.size() == 0 ) ) {
			completion = true;
			bgMusic.stop();
			bgMusic = null;
		}
	...
	public void spawnStage1() {
		if (timer1 < minute / 2) {
			timer1++;
			if (aliens.size() == 0) {
				aliens.add(new Corvette(-80, 10, 1));
				aliens.add(new Corvette(-80, 85, 1));
				aliens.add(new Corvette(-80, 160, 1));
				aliens.add(new Frigate(-293, 10, 1));
				aliens.add(new Frigate(-293, 150, 1));
				aliens.add(new Corvette(-506, 10, 1));
				aliens.add(new Corvette(-506, 85, 1));
				aliens.add(new Corvette(-506, 160, 1));
				aliens.add(new Corvette(-150, 235, 1));
				aliens.add(new Corvette(-150, 310, 1));
				aliens.add(new Corvette(-150, 385, 1));
				aliens.add(new Corvette(-363, 235, 1));
				aliens.add(new Corvette(-363, 310, 1));
				aliens.add(new Corvette(-363, 385, 1));
				aliens.add(new Corvette(-576, 235, 1));
				aliens.add(new Corvette(-576, 310, 1));
				aliens.add(new Corvette(-576, 385, 1));
			}
		}
	}
	public void spawnStage2() {
		if (timer1 >= minute / 2 && timer2 < minute / 2) {
			timer2++;
			if (aliens.size() == 0) {
				aliens.add(new Frigate(-80, 10, 1));
				aliens.add(new Frigate(-80, 150, 1));
				aliens.add(new Frigate(-400, 10, 1));
				aliens.add(new Frigate(-400, 150, 1));
				aliens.add(new Corvette(-150, 235, 1));
				aliens.add(new Corvette(-150, 310, 1));
				aliens.add(new Corvette(-150, 385, 1));
				aliens.add(new Corvette(-363, 235, 1));
	...
	public void spawnStage3() {
		if (timer2 >= minute / 2 && timer3 < minute / 2) {
			timer3++;
			if (aliens.size() == 0) {
				aliens.add(new Frigate(125, -520, 2));
				aliens.add(new Frigate(125, -400, 2));
				aliens.add(new Frigate(125, -280, 2));
				aliens.add(new Frigate(125, -160, 2));
				aliens.add(new Frigate(445, -520, 2));
				aliens.add(new Frigate(445, -400, 2));
				aliens.add(new Frigate(445, -280, 2));
				aliens.add(new Frigate(445, -160, 2));
			}
		}
	}
