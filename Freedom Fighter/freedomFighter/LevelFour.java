...
public class LevelFour implements Level {
	...
	public LevelFour() {
		...
		try {
			background = GameDriver.addImage("background\\Anchorage.jpg");
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void drawInfoPanel(Graphics2D g2) {
		...
		if (score > 99) g2.drawString("Score: " + score, 1220, 15);
