...
public class LevelThree implements Level {
	...
	public LevelThree() {
		...
		try {
			background = GameDriver.addImage("background\\Los Angeles.jpg");
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void spawnStage1() {
		if (timer1 < minute / 2) {
			timer1++;
			if (aliens.size() == 0) {
				aliens.add(new Frigate(80, -520, 3));
				aliens.add(new Frigate(80, -400, 3));
				aliens.add(new Frigate(80, -280, 3));
				aliens.add(new Frigate(80, -160, 3));
				aliens.add(new Frigate(287, -520, 3));
				aliens.add(new Frigate(287, -400, 3));
				aliens.add(new Frigate(287, -280, 3));
				aliens.add(new Frigate(287, -160, 3));
				aliens.add(new Frigate(500, -520, 3));
				aliens.add(new Frigate(500, -400, 3));
	...
	public void spawnStage2() {
		if (timer1 >= minute / 2 && timer2 < minute / 2) {
			timer2++;
			if (aliens.size() == 0) {
				aliens.add(new HeavyFrigate(80, -520, 1));
				aliens.add(new Frigate(80, -400, 3));
				aliens.add(new Frigate(80, -280, 3));
				aliens.add(new Frigate(80, -160, 3));
				aliens.add(new HeavyFrigate(287, -520, 1));
				aliens.add(new Frigate(287, -400, 3));
				aliens.add(new Frigate(287, -280, 3));
				aliens.add(new Frigate(287, -160, 3));
				aliens.add(new HeavyFrigate(500, -520, 1));
				aliens.add(new Frigate(500, -400, 3));
				aliens.add(new Frigate(500, -280, 3));
				aliens.add(new Frigate(500, -160, 3));
			}
