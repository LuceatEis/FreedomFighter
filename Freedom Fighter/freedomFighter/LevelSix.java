...
public class LevelSix implements Level {
	...
	public LevelSix() {
		...
		try {
			background = GameDriver.addImage("background\\Shanghai.jpg");
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void spawnStage2() {
		if (timer1 >= minute / 2 && timer2 < minute / 2) {
			timer2++;
			if (aliens.size() == 0) {
				aliens.add(new Destroyer(20, -160, 3));
				aliens.add(new Destroyer(20, -320, 3));
				aliens.add(new Destroyer(20, -480, 3));
				aliens.add(new Destroyer(20, -640, 3));
				aliens.add(new Destroyer(20, -800, 3));
				aliens.add(new Destroyer(20, -960, 3));
				aliens.add(new Destroyer(20, -1120, 3));
				aliens.add(new Destroyer(20, -1280, 3));
				aliens.add(new Destroyer(20, -1440, 3));
				aliens.add(new Destroyer(20, -1600, 3));
				
				aliens.add(new DestroyerTwo(85, -200, 1));
				aliens.add(new DestroyerTwo(245, -200, 1));
				aliens.add(new DestroyerTwo(405, -200, 1));
			}
		}
	}
