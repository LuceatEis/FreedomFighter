...
public class LevelFive implements Level {
	...
	public LevelFive() {
		...
		try {
			background = GameDriver.addImage("background\\Tokyo.jpg");
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void spawnStage1() {
		if (timer1 < minute / 2) {
			timer1++;
			if (aliens.size() == 0) {
				aliens.add(new LightDestroyer(20, -160, 2));
				aliens.add(new LightDestroyer(20, -320, 2));
				aliens.add(new LightDestroyer(20, -480, 2));
				aliens.add(new LightDestroyer(20, -640, 2));
				aliens.add(new LightDestroyer(20, -800, 2));
				aliens.add(new LightDestroyer(20, -960, 2));
				aliens.add(new LightDestroyer(20, -1120, 2));
				aliens.add(new LightDestroyer(20, -1280, 2));
				aliens.add(new LightDestroyer(20, -1440, 2));
				aliens.add(new LightDestroyer(20, -1600, 2));
				aliens.add(new Destroyer(163, -300, 1));
				aliens.add(new Destroyer(377, -300, 1));
			}
		}
	}
	public void spawnStage2() {
		if (timer1 >= minute / 2 && timer2 < minute / 2) {
			...
			if (aliens.size() == 0) {
				aliens.add(new LightDestroyer(20, -160, 2));
				aliens.add(new LightDestroyer(20, -448, 2));
				aliens.add(new LightDestroyer(20, -736, 2));
				aliens.add(new LightDestroyer(20, -1024, 2));
				aliens.add(new LightDestroyer(20, -1312, 2));
				aliens.add(new LightDestroyer(20, -1600, 2));
				aliens.add(new Destroyer(78, -300, 1));
				aliens.add(new Destroyer(334, -300, 1));
				aliens.add(new Destroyer(206, -150, 1));
				aliens.add(new Destroyer(462, -150, 1));
			}
		}
	}
	public void spawnStage3() {
		if (timer2 >= minute / 2 && timer3 < minute) {
			timer3++;
			if (aliens.size() == 0) {
				aliens.add(new Destroyer(20, -160, 2));
				aliens.add(new Destroyer(20, -320, 2));
				aliens.add(new Destroyer(20, -480, 2));
				aliens.add(new Destroyer(20, -640, 2));
				aliens.add(new Destroyer(20, -800, 2));
				aliens.add(new Destroyer(20, -960, 2));
				aliens.add(new Destroyer(20, -1120, 2));
				aliens.add(new Destroyer(20, -1280, 2));
				aliens.add(new Destroyer(20, -1440, 2));
				aliens.add(new Destroyer(20, -1600, 2));
				aliens.add(new Destroyer(20, -1760, 2));
			}
		}
	}
